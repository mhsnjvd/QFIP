...
parallel and again, $\rho_{XZ}=1$.

For the general case, if $X, Y$ make an angle 
$\alpha$ and $Y, Z$ make an angle $\alpha$, 
then $X$ and $Z$ can make any angle between 
$0$ and $2\alpha$. 
...
your hit ratio as the number of trades you have 
...
Yes. Let $k$ be the number of trades lost out of a total of $n$
...
The variable $n$ being discrete must be equal 
