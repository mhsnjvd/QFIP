...
is $QQ^*$. The QR decomposition and the projection matrix 
lead to the least squares solution of finding $x$ such 
that $Ax-b$ has the smallest 2-norm. We have,
\begin{align*}
Ax &= Proj(b)\\
QRx &= QQ^*b\\
Rx &= Q^*b\\
...
as the vector. 
\begin{proof}
Let ${x_j}$ be a finite orthonormal set in a Hilbert space $\mathcal{H}$.
