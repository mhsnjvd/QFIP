...
\subsection{Glossary}
\begin{itemize}
\item Spread: Spread is the constant (absolute) shift to the zero-coupon discount curve in all scenarios that is required to ensure that the model value of the bond (average value over all scenarios) equals the observed market price \cite{benDor2007Spread}.
...
Let $y$ be the yield of a bond with price $B$. Then  
\begin{equation}
\frac{1}{B} dB = -D dy + \frac{1}{2} C dy^2,
\end{equation}
...
\bibitem {papoulis2002probability} Papoulis, A. and Pillai, S. U.,
  \textit{Probability, Random Variables, and Stochastic Processes},
  McGraw-Hill Education, 4th Edition, 2002  
